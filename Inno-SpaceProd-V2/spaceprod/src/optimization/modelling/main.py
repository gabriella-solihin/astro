...
@timeit
def task_opt_modelling_construct_all_sets():
    ...
    df = context.data.read("task_opt_pre_proc_region_banner_dept_store")
    ...
    context.data.write("task_opt_modelling_construct_all_sets", df_result)


@timeit
def task_opt_modelling_create_and_solve_model():
    path_opt_data_containers = context.data.path("data_containers_parent_path")
    ...
    large_number = conf_opt_param["large_number"]
    enable_supplier_own_brands_constraints = conf_opt_param[
    ...
    id = "task_opt_modelling_construct_all_sets"
